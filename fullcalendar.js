...
// Do these segments occupy the same vertical space?
    ...
    var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
        ...
        selectEvent: function (event) {
            ...
            //generateHtml(event);
            status="1";
            sessionStorage.setItem("array",JSON.stringify({'id':event.id,'_id':event._id,'start':event.start._i,'end':event._end._i}));
            selectButton();
            //getParentForSelectEvent();
        },


        unselectEvent: function (event) {
    ...
    function Calendar_constructor(element, overrides) {
        ...
        function initialRender() {
            ...
            content = $("<div class='fc-view-container' id='main-container'/>").prependTo(element);
...
// TODO: rename all header-related things to "toolbar"
    ...
    function Header(calendar) {
        ...
        function render() {
            ...
            if (sections) {
                if (!el) {
                    el = this.el = $("<div class='fc-toolbar' id='fc-toolbar'/>");
                }
                else {
                    el.empty();
                }
    ...
    var AgendaView = FC.AgendaView = View.extend({
        ...
        initialize: function () {
            ...
            if (this.opt('allDaySlot')) { // should we display the "all-day" area?
             this.dayGrid = this.instantiateDayGrid(); // the all-day subcomponent of this view   //close all day add by dean
             }
